...
func (in *PipelineRunStatusList) DeepCopy() *PipelineRunStatusList {
	if in == nil {
		return nil
	}
	out := new(PipelineRunStatusList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PipelineRunStatusSpec) DeepCopy() *PipelineRunStatusSpec {
	if in == nil {
		return nil
	}
	out := new(PipelineRunStatusSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PipelineRunStatusStatus) DeepCopy() *PipelineRunStatusStatus {
	if in == nil {
		return nil
	}
	out := new(PipelineRunStatusStatus)
	in.DeepCopyInto(out)
	return out
}
